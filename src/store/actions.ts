import { ActionTypes, UPDATE_TIME, UPDATE_LOADING_LAND_STATUS, UPDATE_LOADING_TERRITORY_STATUS , SELECT_TERRITORY, START_RENAMING, ASK_FOR_EDITION_TYPE, CANCEL_EDITION, FINISH_EDITION, UPDATE_MPSTATES} from "./types";
